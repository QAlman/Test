...
public class Sphere_MSK_proactiv {
        ...
        public void setUp() throws Exception {
            ...
            // baseUrl = "https://10.0.14.112/mskt/index";
        ...
        public void testUntitSphereAut() throws Exception {
            ...
            for (i =0; i < 10; i++) {
                ...
                TimeUnit.SECONDS.sleep(2);
                System.out.println("13");
                driver.findElement(By.id("snils")).sendKeys("000-"+ s + i +"-000 01");
                ...
                driver.findElement(By.id("children_0_snils")).sendKeys("000-"+ s + i +"-000 02");
                ...
                driver.findElement(By.id("children_1_snils")).sendKeys("000-"+ s + i +"-000 03");
